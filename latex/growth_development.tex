...
requirement is not reached before VERNDVS a warning is issued to the user.
...
thus nine iterations are required: three periods
of the day multiplied by three depths into the crop canopy. Finally, the actual gross photosynthesis rate is 
...
\subsection{Potential daily gross CO$_{{\rm 2}}$ assimilation rate of the canopy}
...
for a several days, the assimilates accumulate in the leaves and the assimilation rate diminishes 
