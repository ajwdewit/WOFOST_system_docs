...
% PDF formatting
\usepackage[pdftitle={System description of the WOFOST 7.2 crop simulation model},pdfpagemode=UseOutlines, pdfauthor={Allard de Wit}, pdfpagetransition=Dissolve, bookmarks=true]{hyperref}
